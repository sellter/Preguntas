...
<div class='container'>
      ...
      <form class='form-signin' role='form' action='system.php' method='post'>
        ...
        <tr><td><input type='text' id='usr' name=usr  placeholder='usuario' required autofocus></td></tr>
        <tr><td><input type='password' id='psw' name=psw  placeholder='Password' required></td></tr>
